...
<style scoped>
.page{display:flex;min-height:100vh;overflow:hidden}
...
.brand-panel::after{
  content:'迎';position:absolute;font-size:26rem;font-weight:900;
...
.logo-wrap{
  width:100px;height:100px;border-radius:50%;padding:3px;margin:0 auto;
  background:linear-gradient(135deg,#c9a96e 0%,#e8d5a8 50%,#c9a96e 100%);
}
.logo{width:100%;height:100%;border-radius:50%;object-fit:contain;background:#fff;display:block}
.school-name{font-size:1.45rem;font-weight:700;color:#f2e6d0;letter-spacing:.08em;margin-top:22px;line-height:1.4}
.motto{font-size:.92rem;color:#c4a87e;margin-top:10px;letter-spacing:.12em}
...
@media(max-width:720px){
  ...
  .brand-panel{flex:0 0 auto;min-height:44vh}
  .brand-inner{padding:36px 24px}
  .logo-wrap{width:80px;height:80px}
  .school-name{font-size:1.25rem}
  .year-badge{font-size:2.4rem}
  .brand-rule{margin:20px auto 18px}
  .form-panel{flex:0 0 auto;min-height:56vh}
  .form-inner{width:100%;max-width:100%;padding:32px 28px 40px}
  .form-heading{font-size:1.6rem}
  .form-desc{margin-bottom:24px}
  .watermark{font-size:12rem;bottom:-40px;right:-30px}
}
</style>
